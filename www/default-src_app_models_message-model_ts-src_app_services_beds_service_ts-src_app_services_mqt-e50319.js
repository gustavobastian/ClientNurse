...
const VoiceRecorder = (0,_capacitor_core__WEBPACK_IMPORTED_MODULE_0__.registerPlugin)('VoiceRecorder', {
    web: () => __webpack_require__.e(/*! import() */ "node_modules_capacitor-voice-recorder_dist_esm_web_js").then(__webpack_require__.bind(__webpack_require__, /*! ./web */ 4366)).then(m => new m.VoiceRecorderWeb()),
});
